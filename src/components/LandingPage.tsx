  ...
  const features = [
    {
      ...
      description: 'Intelligent configuration management with auto-detection and validation for seamless AWS Cognito setup.',
      color: 'blue',
    ...
    },
    {
      ...
      description: 'Comprehensive authentication testing with real-time token analysis and detailed flow debugging.',
      color: 'purple',
    ...
    },
    {
      ...
      description: 'Streamlined user registration flows with intelligent validation and automated testing capabilities.',
      color: 'green',
    ...
    },
    {
      ...
      description: 'Enterprise-grade password recovery testing with multi-factor authentication and security auditing.',
      color: 'pink',
    ...
    },
    {
      icon: Shield,
      title: 'MFA & Security',
      description: 'Advanced multi-factor authentication testing with TOTP support and comprehensive security validation.',
      color: 'blue',
    ...
    },
    {
      icon: Bug,
      title: 'Debug Console',
      description: 'Powerful debugging console with detailed API logging and comprehensive error analysis tools.',
      color: 'purple',
          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">Professional Authentication Testing</p>
              </div>
            </motion.div>
      ...
      <section className="relative z-10 py-32 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            >
              Experience the future of AWS Cognito debugging with our revolutionary platform. 
              Featuring advanced analysis tools, real-time 3D visualizations, and high-speed processing 
              for the most comprehensive authentication testing suite ever created.
            </motion.p>
          </motion.div>
            ...
            <GlowingCard className="overflow-hidden" glowColor="blue">
              <div className="bg-gradient-to-br from-slate-900/90 to-purple-900/90 backdrop-blur-xl">
                <div className="bg-black/40 px-6 py-4 flex items-center space-x-2 border-b border-white/10">
                  ...
                  <span className="text-slate-300 text-sm ml-4 font-mono">cognito-debug-matrix.exe</span>
                </div>
                <div className="p-12 min-h-96 flex items-center justify-center relative">
                  ...
                  >
                    ...
                    <h3 className="text-2xl font-bold text-white mb-4">Advanced Debug Interface</h3>
                    <p className="text-slate-300 mb-6">Click "Launch Debug Matrix" to enter the testing environment</p>
                    <motion.div 
            ...
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className={`w-16 h-16 bg-gradient-to-r ${feature.gradient} rounded-2xl flex items-center justify-center mb-6 relative`}>
            ...
            {benefits.map((benefit, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-sm text-slate-400 mb-4">{benefit.metricLabel}</div>
          ...
          <GlowingCard className="p-16" glowColor="purple">
            ...
            >
              ...
              <p className="text-xl text-slate-300 mb-12">
                Join the professional debugging revolution and test like never before
              </p>
              
              <InteractiveButton onClick={onEnterTool} size="lg" className="text-xl px-12 py-6">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            >
              ...
              <span className="text-slate-300 font-medium">AWS Cognito Debug Tool</span>
            </motion.div>
            
            <div className="flex items-center space-x-8">
              <span className="text-slate-400 text-sm">
                Developed by <span className="text-white font-medium">Muneeb</span>
              </span>
